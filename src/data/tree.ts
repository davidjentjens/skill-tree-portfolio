        ...
        children: [
            ...
            children: [
              { 
                ...
                data: { 
                  ...
                  color: '#2980B9',
                  details: 'Coordinating developers and QA team, implementing testing strategies, managing design system centralization',
                  year: 2024,
                } 
              },
              { 
                ...
                data: { 
                  ...
                  color: '#2980B9',
                  details: 'Created/maintained front-end libraries for mining industry clients, managed CI/CD pipeline, documentation',
                  year: 2023,
                } 
              }
            ]
          },
          {
            ...
            data: { 
              ...
              color: '#3498DB',
              details: 'Full Stack Developer: Next.js, Ruby on Rails, Created "Solaris" design system',
              year: 2023,
            }
          },
          {
            ...
            data: { 
              ...
              color: '#3498DB',
              details: 'Full Stack Developer: Transportation logistics platform with React, Node, .NET Core, SQL Server',
              year: 2022,
            }
          },
          {
            ...
            children: [
              { 
                ...
                data: { 
                  ...
                  color: '#2980B9',
                  details: 'React web interfaces for Petrobras and Intel, back-end with Node.js and C#',
                  year: 2020,
                } 
              },
              { 
                ...
                data: { 
                  ...
                  color: '#2980B9',
                  details: 'AI projects for Petrobras and Intel using React.js, Node.js, Python, C#',
                  year: 2018,
                } 
              }
            ]
          },
          {
            ...
            data: { 
              ...
              color: '#3498DB',
              details: 'Junior Product Manager: Product team coordination, development infrastructure management',
              year: 2020,
            }
          }
        ],
